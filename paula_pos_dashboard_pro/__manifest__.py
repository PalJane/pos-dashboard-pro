...
""",
    ...
    'assets': {
        'web.assets_backend': [
            'paula_pos_dashboard_pro/static/src/lib/chart.umd.js',
            'paula_pos_dashboard_pro/static/src/js/**/*',
            'paula_pos_dashboard_pro/static/src/xml/**/*',
            'paula_pos_dashboard_pro/static/src/scss/**/*',
        ],
    },
