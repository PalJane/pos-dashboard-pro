...
class PosDashboardPro extends Component {
    static template = "paula_pos_dashboard_pro.Dashboard";
    ...
    async loadData() {
        ...
        try {
            const result = await rpc("/paula_pos_dashboard_pro/data", {
...
registry.category("actions").add("paula_pos_dashboard_pro", PosDashboardPro);
